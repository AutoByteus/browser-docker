...
- Remaining blockers, rollback concerns, or untested scope: No browser-image release blocker remains. Previous `1.3.8`/`1.3.8-zh` index digests remain recorded for rollback visibility. Ticket branch/worktree cleanup follows the final delivery-record push and will be reflected in the authoritative release report.
